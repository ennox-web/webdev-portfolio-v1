describe("verify menu elements", () => {
    ...
    it("loads menu", () => {
        ...
        cy.get('[data-cy="menu-job-position"]').should(
            "have.text",
            "Software Engineer",
        );
        ...
        cy.get('[data-cy="socials-linkedin"]')
            .should("be.visible")
            .and("have.attr", "href", "https://www.linkedin.com/in/ennox/");
        cy.get('[data-cy="socials-github"]')
            .should("be.visible")
            .and("have.attr", "href", "https://github.com/ennox-web");
    });
